...
return {
  {
    ...
    config = function()
      require("koda").setup()
      if is_active("koda") then vim.cmd("colorscheme koda") end
    end,
  },
  {
    ...
    config = function()
      require("vague").setup()
      if is_active("vague") then vim.cmd("colorscheme vague") end
    end,
  },
  {
    ...
    config = function()
      if is_active("oxocarbon") then vim.cmd("colorscheme oxocarbon") end
    end,
  },
  {
    ...
    config = function()
      if is_active("yugen") then vim.cmd("colorscheme yugen") end
    end,
  },
  {
    ...
    config = function()
      if is_active("moonfly") then vim.cmd("colorscheme moonfly") end
    end,
  },
}
