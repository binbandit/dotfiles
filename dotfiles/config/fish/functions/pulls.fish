function pulls --description 'Open repository pull request page from git remote'
    ...
    set pullquery "pulls?q=sort%3Aupdated-desc+is%3Apr+is%3Aopen+author%3ABrayden_cba"
